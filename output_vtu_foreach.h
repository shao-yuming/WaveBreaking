...
void output_vtu_pid (scalar * list, vector * vlist, int n, FILE * fp, bool linear)
{
...
void output_pvtu(scalar * list, vector * vlist, int n, FILE * fp, char * subname)
{
...
**/
//void output_vtu_plane_pid (scalar * list, vector * vlist,  FILE * fp, coord n, double _alpha){

//void output_pvtu_plane (struct OutputSlicesVTU p) {
 void output_pvtu_plane (scalar * list, vector * vlist,  FILE * fp, char * subname) {
